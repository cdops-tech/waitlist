      ...
      <div className="bg-dark-card border border-dark-border rounded-2xl p-8 md:p-10 shadow-2xl">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <button
            ...
            className="flex items-center justify-center gap-3 bg-[#0077b5] hover:bg-[#006399] text-white font-semibold py-3 px-6 rounded-lg transition-all transform hover:scale-105 active:scale-95"
          >
          ...
          <button
            ...
            className="flex items-center justify-center gap-3 bg-[#1877f2] hover:bg-[#166fe5] text-white font-semibold py-3 px-6 rounded-lg transition-all transform hover:scale-105 active:scale-95"
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
          ...
          <button
            ...
            className="flex items-center justify-center gap-3 bg-black hover:bg-gray-900 text-white font-semibold py-3 px-6 rounded-lg transition-all transform hover:scale-105 active:scale-95 border border-gray-800"
          >
